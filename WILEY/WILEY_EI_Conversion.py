...
def load_inchikey_mapping(inchi_mapping):
    ...
    return inchikey_to_inchi_mapping
...
def main():
    ...
    try:
        inchikey_to_inchi_mapping = load_inchikey_mapping(sys.argv[4])
    except:
        print("No mapping")
    ...
    for line in txt_file:
        ...
        if len(line.strip()) < 1:
            ...
            spectrum_string += "NAME=" + "WILEY:" + wiley_no.rstrip() + " " + compound_name.rstrip() + "\n"
            spectrum_string += "ORGANISM=WILEY\n"
